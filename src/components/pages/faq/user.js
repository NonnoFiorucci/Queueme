...
function User() {
    return (
       ...
       <h3>Come aggiungo una coda ai preferiti?</h3>
        <p className='just'>Semplicissimo, per aggiungere una coda ai preferiti basterà premere il pulsante <TiHeartOutline size={30}/> della determinata coda.
        </p>
        <br/> <br/>
       <h3>Come tolgo una coda dai preferiti?</h3>
        ...
        il pulsante dei preferiti, il quale, per indicare quali sono le code aggiunte ai preferiti, è variato in <TiHeartFullOutline size={30}/>.
        </p>
        <br/> <br/>
